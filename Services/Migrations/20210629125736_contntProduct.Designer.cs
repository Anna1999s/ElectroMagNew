...
namespace Services.Migrations
{
    ...
    [Migration("20210629125736_contntProduct")]
    partial class contntProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainModel.Content.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainModel.Content.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainModel.Content.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainModel.Content.OrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DomainModel.Content.BasketItem", b =>
                {
                    b.HasOne("DomainModel.Content.Basket", "Basket")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DomainModel.Content.OrderProduct", b =>
                {
                    b.HasOne("DomainModel.Content.Order", "Order")
            ...
            modelBuilder.Entity("DomainModel.Content.Product", b =>
                {
                    b.HasOne("DomainModel.Content.Brand", "Brand")
                        .WithMany("Products")
