...
namespace WebSite.Areas.Admin.Controllers
{
    ...
    public class WarehousesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Count")] Warehouse warehouse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Count")] Warehouse warehouse)
        {
            if (id != warehouse.Id)
            {
                return NotFound();
